...
class Agregar_Alimento(New_ventana):
    ...
    def add_widget_agregar(self):
        ...
        self.label_agregar.place(relx=0.1, rely=0.383, relwidth=0.3, relheight=0.05)  # Ajustar rely
        ...
        self.combo_box.place(relx=0.5, rely=0.2, relwidth=0.3, relheight=0.05)  # Ajustar rely
        ...
        self.entry_calorias.place(relx=0.1, rely=0.435, relwidth=0.25, relheight=0.05)  # Ajustar rely
        ...
        self.boton_agregar.place(relx=0.5, rely=0.39)  # Ajustar rely

        # Imagen del botón
        self.mas = util_img.leer_imagen("./img/mas2.png", (25, 25))
        labelmas = tk.Label(self.sub, image=self.mas)
        labelmas.place(relx=0.349, rely=0.435, relwidth=0.05, relheight=0.05)  # Ajustar rely
