...
class Agregar_Alimento(New_ventana):
    ...
    # Label "Buscador de alimentos"
        ...
        self.entry_buscar = ctk.CTkEntry(self.sub, corner_radius= 0, placeholder_text="Nombre del alimento", placeholder_text_color="white", border_width=0, fg_color="#183549")
        self.entry_buscar.place(relx=0.1, rely=0.25, relwidth=0.3, relheight=0.1)   

        # Label "Seleccione Cantidad Calorias"
        self.label_agregar = ctk.CTkLabel(self.sub, text="Seleccione Cantidad Calorias",text_color="White", fg_color="Black")
        self.label_agregar.place(relx=0.1, rely=0.45, relwidth=0.3, relheight=0.05)

        # ComboBox
        self.combo_box = ctk.CTkComboBox(self.sub, corner_radius=0 ,fg_color="White", values=["","100gr", "Por porcion"],
                                        border_width=0, button_color="#26656D", button_hover_color="white")
